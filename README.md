...
$hroute->addRoute("user/<id:\d+>","user/get","get");
...
参数 |<div style="width:30%">说明</div>| 方法名| 示例
----------|-------------|------------|------------
...
$hroute->addRoute('news/<year:\d{4}>/<category>','news/<category>');
// 当前访问地址:news/2014/list
$matchingResult = $hroute->parseRequest();
// url:news/2014/list
$url = $hroute->buildUrL(true);

$hroute->addRoute('news/<category>','article/<category>');
// 当前访问地址:news/list
