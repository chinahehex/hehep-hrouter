<?php
namespace hroute\tests\units;
use hehe\core\hroute\Route;
use hehe\core\hroute\RouteManager;
use hroute\tests\common\AdminController;
use hroute\tests\TestCase;
...
class ExampleTest extends TestCase
{
    ...
    public function testUrlEmpty()
    {
        ...
        $this->assertSame('index/name',$this->getRouter()->buildUrL(''));
        $this->assertSame('index/name',$this->getRouter()->buildUrL(true));
        ...
        $this->assertSame('news/2014/list',$this->getRouter()->buildUrL(true));

        $this->getRouter()->addRoute('news/<category>','article/<category>');
        $matchingResult = $this->getRouter()->parseRequest($this->createRequest("news/list"));
        $this->assertSame('article/list',$matchingResult->getUri());
        $this->assertSame('news/list',$this->getRouter()->buildUrL(''));
    }
