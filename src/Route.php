...
class Route
{
    ...
    public static function get(string $uri = '',string $action = '',array $options = []):Rule
    {
        return static::addRoute($uri,$action,self::GET_METHOD,$options);
    }

    public static function post(string $uri = '',string $action = '',array $options = []):Rule
    {
        return static::addRoute($uri,$action,self::POST_METHOD,$options);
    }

    public static function put(string $uri = '',string $action = '',array $options = []):Rule
    {
        return static::addRoute($uri,$action,self::PUT_METHOD,$options);
    }

    public static function patch(string $uri = '',string $action = '',array $options = []):Rule
    {
        return static::addRoute($uri,$action,self::PATCH_METHOD,$options);
    }

    public static function delete(string $uri = '',string $action = '',array $options = []):Rule
    {
        return static::addRoute($uri,$action,self::DELETE_METHOD,$options);
    }

    public static function head(string $uri = '',string $action = '',array $options = []):Rule
    {
        return static::addRoute($uri,$action,self::HEAD_METHOD,$options);
    }

    public static function any(string $uri = '',string $action = '',array $options = []):Rule
    {
