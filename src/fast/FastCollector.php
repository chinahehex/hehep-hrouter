...
use hehe\core\hroute\base\Collector;
...
class FastCollector extends Collector
{
    ...
    protected function addRouteRule(Rule $rule):void
    {
    ...
    protected function addGroupRule(Rule $rule):void
    {
    ...
    protected function intiRouteRule(Rule $rule):void
    {
