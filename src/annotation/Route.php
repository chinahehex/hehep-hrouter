<?php
namespace hehe\core\hroute\annotation;
...
/**
 * 路由注解类
 * @Annotation("hehe\core\hroute\annotation\RouteProcessor")
 */
#[Annotation("hehe\core\hroute\annotation\RouteProcessor")]
#[Attribute]
class Route
{
     ...
     *</pre>
     */
    public function __construct($value = null,string $action = '',string $method = '',string $id = '',?array $defaults = [],string $pvar = null,?array $prule = [],string $uri = null)
    {
