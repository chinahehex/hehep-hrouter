...
class Rule
{
     ...
     * @return bool
     */
    public function isGroupRule():bool
    {
        return $this->groupId !== '';
    }
     ...
     * @return bool
     */
    public function hasInitStatus():bool
    {
     ...
     * @return bool
     */
    public function hasUriVar():bool
    {
     ...
     * @return bool
     */
    public function hasActionVar():bool
    {
    ...
    public function getUriMergeRegex():string
    {
    ...
    public function getActionVars():array
    {
    ...
    public function buildVarName(string $name):string
    {
        return "<{$name}>";
    }

    public function buildRegex(string $regex,string $end = '$#u',string $first = '#^'):string
    {
     ...
     * @return array|null [URL地址,URL 参数]
     */
    public function parseRequest(string $pathinfo,?RouteRequest $routeRequest = null,array $matches = []):?array
    {
     ...
     * @return array|null [URL地址,URL 参数]
     */
    public function parseUrL(string $url = '',array $params = [],array $matches = []):?array
    {
