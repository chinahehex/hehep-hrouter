<?php
namespace hehe\core\hroute\params;

use hehe\core\hroute\base\ParamRule;
...
class SingleParam extends ParamRule
{
    ...
    protected function formatPatternParams(array $patternParams):array
    {
        $replaceParams = [];
     ...
     *</pre>
     */
    private function matchParams(string $pattern):array
    {
        $patternParams = [];
    ...
    public function parse(string $param):array
    {
        $var = [];
